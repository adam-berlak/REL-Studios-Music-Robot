...
class TestScaleMethods(unittest.TestCase):
    ...
    def test_scale_creation(self):
        self.assertEqual(str(Scale(C_flat, [P1, M2, M3, P4, P5, M6, M7])), "[Cb, Db, Eb, Fb, Gb, Ab, Bb]")
        self.assertEqual(str(Scale(C, [P1, M2, M3, P4, P5, M6, M7])), "[C, D, E, F, G, A, B]")
        self.assertEqual(str(Scale(C_sharp, [P1, M2, M3, P4, P5, M6, M7])), "[C#, D#, E#, F#, G#, A#, B#]")
        self.assertEqual(str(Scale(D_flat, [P1, M2, M3, P4, P5, M6, M7])), "[Db, Eb, F, Gb, Ab, Bb, C]")
        self.assertEqual(str(Scale(D, [P1, M2, M3, P4, P5, M6, M7])), "[D, E, F#, G, A, B, C#]")
        self.assertEqual(str(Scale(D_sharp, [P1, M2, M3, P4, P5, M6, M7])), "[D#, E#, F##, G#, A#, B#, C##]")
        self.assertEqual(str(Scale(E_flat, [P1, M2, M3, P4, P5, M6, M7])), "[Eb, F, G, Ab, Bb, C, D]")
        self.assertEqual(str(Scale(E, [P1, M2, M3, P4, P5, M6, M7])), "[E, F#, G#, A, B, C#, D#]")
        self.assertEqual(str(Scale(E_sharp, [P1, M2, M3, P4, P5, M6, M7])), "[E#, F##, G##, A#, B#, C##, D##]")
        self.assertEqual(str(Scale(F_flat, [P1, M2, M3, P4, P5, M6, M7])), "[Fb, Gb, Ab, Bbb, Cb, Db, Eb]")
        self.assertEqual(str(Scale(F, [P1, M2, M3, P4, P5, M6, M7])), "[F, G, A, Bb, C, D, E]")
        self.assertEqual(str(Scale(F_sharp, [P1, M2, M3, P4, P5, M6, M7])), "[F#, G#, A#, B, C#, D#, E#]")
        self.assertEqual(str(Scale(G_flat, [P1, M2, M3, P4, P5, M6, M7])), "[Gb, Ab, Bb, Cb, Db, Eb, F]")
        self.assertEqual(str(Scale(G, [P1, M2, M3, P4, P5, M6, M7])), "[G, A, B, C, D, E, F#]")
        self.assertEqual(str(Scale(G_sharp, [P1, M2, M3, P4, P5, M6, M7])), "[G#, A#, B#, C#, D#, E#, F##]")
        self.assertEqual(str(Scale(A_flat, [P1, M2, M3, P4, P5, M6, M7])), "[Ab, Bb, C, Db, Eb, F, G]")
        self.assertEqual(str(Scale(A, [P1, M2, M3, P4, P5, M6, M7])), "[A, B, C#, D, E, F#, G#]")
        self.assertEqual(str(Scale(A_sharp, [P1, M2, M3, P4, P5, M6, M7])), "[A#, B#, C##, D#, E#, F##, G##]")
        self.assertEqual(str(Scale(B_flat, [P1, M2, M3, P4, P5, M6, M7])), "[Bb, C, D, Eb, F, G, A]")
        self.assertEqual(str(Scale(B, [P1, M2, M3, P4, P5, M6, M7])), "[B, C#, D#, E, F#, G#, A#]")
        self.assertEqual(str(Scale(B_sharp, [P1, M2, M3, P4, P5, M6, M7])), "[B#, C##, D##, E#, F##, G##, A##]")
