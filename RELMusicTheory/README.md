...
- Just as how many people manually create midi files based on sheet music, once I am complete this library I 
  ...
  scratch using the concepts within its library. Doing this manually will be tedious but after a decent quantity 
  of pieces are described it might be sufficient to teach an AI to describe the pieces automatically.
```
